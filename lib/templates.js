...
function buildSmsMessage(fullName) {
  ...
  return `Hey ${firstName}! Thanks for requesting your quote from LRG Homes. Are you planning to make a move in the very near future? Reply here or call +16506703914.`;
}
...
<body>
  ...
  <div class="body">
    ...
    <p>Reply to this email or call <strong>+1 (650) 670-3914</strong> if you have any questions.</p>
    <p>— LRG Homes Team</p>
  </div>
  <div class="footer">
...
function buildEmailText(fullName) {
  ...
  return [
    ...
    '',
    'Reply to this email or call +1 (650) 670-3914 if you have any questions.',
    '',
    '— LRG Homes Team',
  ].join('\n');
}
